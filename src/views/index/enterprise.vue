  ...
  <div class="enterprise-container">
    <el-card class="box-card top">
      <el-form :inline="true" :model="formInline" class="demo-form-inline top-form">
        <el-form-item class="fist-item" label="企业编号">
          <el-input v-model="formInline.user"></el-input>
        </el-form-item>
        <el-form-item class="two-item" label="企业名称">
          <el-input v-model="formInline.user"></el-input>
        </el-form-item>
    ...
    >
      <el-form :model="addForm" :rules="addRules" ref="addForm" class="formContent">
        <el-form-item label="企业编号" prop="scienceid" class="addForm-one">
          <el-input v-model="addForm.scienceid" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="企业名称" prop="sciencename" class="addForm-two">
